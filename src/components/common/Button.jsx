...
export const Button = ({
  ...
  const variantStyles = {
    primary: 'bg-gradient-to-r from-[#E63946] to-[#C1121F] text-white shadow-lg shadow-red-900/30 hover:shadow-red-600/40 hover:brightness-110 active:scale-[0.98] border border-red-500/30',
    secondary: 'bg-gradient-to-r from-[#FF5722] to-[#E64A19] text-white shadow-lg shadow-orange-950/40 hover:shadow-orange-600/30 hover:brightness-110 active:scale-[0.98]',
    ...
    accent: 'bg-white text-slate-950 hover:bg-slate-100 font-bold shadow-md active:scale-[0.98]',
  };
